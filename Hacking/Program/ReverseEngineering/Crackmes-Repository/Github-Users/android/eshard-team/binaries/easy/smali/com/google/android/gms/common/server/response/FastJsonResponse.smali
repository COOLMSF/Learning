...
.method private zza(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Ljava/lang/Object;)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzpj()Ljava/lang/Class;
    ...
    invoke-static {p3}, Lcom/google/android/gms/internal/zzls;->zzcA(Ljava/lang/String;)Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzpb()Ljava/util/Map;
    ...
    :cond_2
    invoke-virtual {v1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzpa()I

    move-result v0

    packed-switch v0, :pswitch_data_0

    invoke-virtual {v1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzpf()Z
    ...
    invoke-static {v2}, Lcom/google/android/gms/internal/zzlj;->zzj([B)Ljava/lang/String;
    ...
    invoke-static {v4, v2}, Lcom/google/android/gms/internal/zzlt;->zza(Ljava/lang/StringBuilder;Ljava/util/HashMap;)V
...
.method protected zza(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;)Z
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzpa()I
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzpg()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzph()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzcw(Ljava/lang/String;)Z
...
.method protected zzb(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzpj()Ljava/lang/Class;
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzct(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzpd()Ljava/util/HashMap;
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzpc()Ljava/util/HashMap;
...
.method protected abstract zzcu(Ljava/lang/String;)Z
.end method
...
.method protected zzcw(Ljava/lang/String;)Z
    .locals 2
...
.method public abstract zzpb()Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Ljava/util/Map",
...
.method public zzpc()Ljava/util/HashMap;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public zzpd()Ljava/util/HashMap;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
