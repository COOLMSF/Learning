...
call16(u32 eax, u32 edx, void *func)
{
	...
	// ecx is the address of function transition16(tested in gdb qemu
	// , transition16 has
	// a instruction 'jmp *edx'(at the end of the function) to jump back here.
        "  jmp *%%ecx\n"
